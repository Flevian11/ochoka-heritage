...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/login/otp', [AuthController::class, 'requestOtp'])->name('otp.request');
...
Route::get('/login/otp', [AuthController::class, 'showOtp'])->name('otp.verify');
Route::post('/login/otp/verify', [AuthController::class, 'verifyOtp'])->name('otp.verify.store');
...
Route::middleware(['auth', 'verified.contact'])->prefix('member')->name('member.')->group(function () {
...
Route::middleware(['auth', 'verified.contact'])->prefix('admin')->name('admin.')->group(function () {
    Route::get('/', DashboardController::class)->middleware('permission:members.view')->name('dashboard');
